  ...
  return (
    <>
      <Table
        ...
        parentDivClassName={cn('no-scrollbar relative overflow-x-auto overflow-y-auto bg-white md:w-full mb-4')}
      >
      ...
      <div className={cn('fixed bottom-0 z-2 flex w-full items-center border-t-[1px] border-gray-50 even:bg-blue-50 p-2 lg:w-[calc(100%-6.5rem)]')}>
