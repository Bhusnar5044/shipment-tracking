  ...
  return (
    ...
    >
      <Button
        ...
        variant="outline"
        edges="square"
        className="-l-2 relative mr-3 h-8 w-8 justify-center lg:hidden"
        ...
        <Popover interactionType='click'>
          <div className="flex items-center gap-2 hover:cursor-pointer">
            ...
            <Typography
              ...
              weight="semibold"
              typoColor="grey"
              className="inline-block whitespace-nowrap capitalize tracking-wide"
            >
          ...
          <Popover.Popup placement='bottom-start' className="shadow w-40 p-3">
            <Link
              to="/change-password"
              className="flex w-full items-center gap-2 pb-2 hover:cursor-pointer "
            >
              ...
              <Typography
                ...
                weight="semibold"
                typoColor="grey"
                className=" inline-block capitalize tracking-wide"
              >
                Change Password
              </Typography>
            </Link>
